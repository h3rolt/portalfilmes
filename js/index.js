				...
				<div class="container">
					<div class="row">
						<div class="col-lg-6 lancamento-poster">
							<a target="_blank" class="text-info" href="/portalfilmes/filme.html?id=${filme.id}">
					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col-10">
								...
								<h6 class="card-subtitle mb-2 text-muted">Sobre <a target="_blank" href="/portalfilmes/filme.html?id=${dados.id}" class="text-info">${nomeFilme}</a></h6>
    ...
    for (i = 0; i < 4; i++) {
        ...
        texto += `
			<div class="filme-destaque col-12 col-md-6 col-lg-3 thumbnail ">
				<a target="_blank" href="/portalfilmes/filme.html?id=${filme.id}">
...
document.getElementById("pesquisa-form").addEventListener("submit", function(e) {
    window.location.href = `/portalfilmes/pesquisa.html?query=${document.getElementById("input-search").value}`;
    e.preventDefault();
});
